 ...
 final greenBox= Container(
  ...
  _buildItem(mode) => Flex(
    ...
    },
    {
      ...
      "name": 'Flex主轴对齐方式',
      "priority": 2,
      "subtitle": "【mainAxisAlignment】 : 主轴对齐   【MainAxisAlignment】",
  ...
  _buildItem(mode) => Flex(
    ...
    },
    {
      ...
      "name": 'Flex垂直方向顺序',
      "priority": 4,
      "subtitle": "【verticalDirection】 : 垂直方向顺序   【VerticalDirection】",
  ...
  _buildItem(mode) => Flex(
    ...
    },
    {
      ...
      "name": 'Flex水平方向顺序',
      "priority": 5,
      "subtitle": "【textDirection】 : 水平方向顺序   【TextDirection】",
...
class _CurveAnimatedCrossFadeState extends State<CurveAnimatedCrossFade> {
  ...
  Widget build(BuildContext context) {
    ...
    },
    {
      ...
      "name": 'RichText包含其他组件',
      "priority": 2,
      "subtitle": "使用WidgetSpan来承载普通组件，作为RichText的内容",
      "code": """class RichTextWithWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return RichText(
      text: TextSpan(
  ...
  "DataTable": [
    {
      ...
      "name": 'DataTable基本使用',
      "priority": 1,
      "subtitle": "【columns】 : 列   【List<DataColumn>】\n"
          "【rows】 : 行  【List<DataRow>】",
      "code": """class _Bean {
  final int id;
  final String name;
  ...
  Widget build(BuildContext context) {
    return DataTable(
        columns: columns.map((e) =>
            DataColumn(label: Text(e))).toList(),
        rows: data
            .map((e) => DataRow(cells: [
                  DataCell(Text('\${e.id}')),
    ...
    },
    {
      ...
      "name": 'DataTable的sort',
      "priority": 2,
      "subtitle": "【sortColumnIndex】 : 列号   【int】\n"
...
"""
  ...
  "Spacer": [
    {
      ...
      "name": 'Spacer基本使用',
      "priority": 1,
      "subtitle": "一个Spacer会占据可延伸区域",
      "code": """class OneSpacer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    },
    {
      ...
      "code": """class ManySpacer extends StatefulWidget {
  @override
  ...
  "Theme": [
    {
      ...
      "priority": 1,
      "subtitle": "后代组件可以通过ThemeData.of获取主题的数据进行使用。",
...
class _CustomAnimatedSizeState extends State<CustomAnimatedSize>
  ...
  "ShaderMask": [
    {
      ...
      "code": """class RadialShaderMask extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Wrap(
      spacing: 20,
  ...
  Shader _buildShader(Rect bounds) =>
    ...
    },
    {
      ...
      "subtitle": "通过LinearGradient#createShader创建线性渐变着色器\n"
          "着色器相关知识详见【绘制专辑】",
      "code": """class LinearShaderMask extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Wrap(
      spacing: 20,
  ...
  "DefaultTextStyle": [
    {
      ...
      "code": """class DefaultTextStyleDemo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
  ...
  "IconTheme": [
    {
      ...
      "code": """class IconThemeDemo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return IconTheme(
      data: IconThemeData(
  ...
  "ButtonTheme": [
    {
      ...
      "code": """class ButtonThemeDemo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ButtonTheme(
  ...
  "DividerTheme": [
    {
      ...
      "code": """class DividerThemeDemo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return DividerTheme(
  ...
  "SliderTheme": [
    {"widgetId": 331,
      ...
      "code": """class SliderThemeDemo extends StatefulWidget {
  @override
...
class _SliderThemeDemoState extends State<SliderThemeDemo> {
  ...
  Widget build(BuildContext context) {
    ...
    { "widgetId": 331,
      ...
      "code": """class DIYSliderTheme extends StatefulWidget {
  @override
